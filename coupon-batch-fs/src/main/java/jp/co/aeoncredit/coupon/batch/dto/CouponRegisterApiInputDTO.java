...
/**
 * クーポン新規登録・更新API INPUTDTO(全クーポン共通)
 */
public class CouponRegisterApiInputDTO {
	...
	private CouponRegisterApiInputDTOAdditional additionalItems;

	/** アプリ内メッセージ設定 */
	@JsonInclude(JsonInclude.Include.NON_NULL)
	@JsonProperty("delivery")
	private CouponRegisterApiInputDTODelivery delivery;

	/** Push通知設定 */
	@JsonInclude(JsonInclude.Include.NON_NULL)
	@JsonProperty("pushTarget")
	private CouponRegisterApiInputDTOPushTarget pushTarget;
	 ...
	 */
	public CouponRegisterApiInputDTOAdditional getAdditionalItems() {
		return additionalItems;
	}
	 ...
	 */
	public void setAdditionalItems(CouponRegisterApiInputDTOAdditional additionalItems) {
	 ...
	 * @return delivery
	 */
	public CouponRegisterApiInputDTODelivery getDelivery() {
		return delivery;
	}

	/**
	 * @param delivery セットする delivery
	 */
	public void setDelivery(CouponRegisterApiInputDTODelivery delivery) {
	 ...
	 * @return pushTarget
	 */
	public CouponRegisterApiInputDTOPushTarget getPushTarget() {
		return pushTarget;
	}
	 ...
	 */
	public void setPushTarget(CouponRegisterApiInputDTOPushTarget pushTarget) {
