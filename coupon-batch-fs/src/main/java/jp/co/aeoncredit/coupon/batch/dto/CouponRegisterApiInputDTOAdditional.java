...
/**
 * クーポン新規登録・更新API 任意追加項目INPUTDTO(全クーポン共通)
 */
public class CouponRegisterApiInputDTOAdditional {
	...
	/** 加盟店グループID（B18B0013：マス、ターゲット、パスポート用） */
	@JsonInclude(JsonInclude.Include.NON_NULL)
	@JsonProperty("_merchantGroupId")
	private String merchantGroupId;

	/** 加盟店グループID（B18B0013：アプリ、センサー用） */
	@JsonInclude(JsonInclude.Include.NON_NULL)
	...
	private List<CouponRegisterApiInputDTOIncentive> incentive;
	...
	/**
	 * @param merchantGroupId セットする merchantGroupId
	 */
	 ...
	 * @return incentive
	 */
	public List<CouponRegisterApiInputDTOIncentive> getIncentive() {
		return incentive;
	}
	 ...
	 */
	public void setIncentive(List<CouponRegisterApiInputDTOIncentive> incentive) {
